...
import { loginAPI } from "@/config/api.fast";
            ...
            <Layout className="layout-default layout-signin">
                ...
                <Footer>
                    <Menu mode="horizontal">
                        <Menu.Item>Về Group 29 Production</Menu.Item>
                    ...
                    <p className="copyright">
                        {" "}
                        Copyright © 2025 An production of group 29, developed by <a href="#pablo">HieuPahm-R2</a>.{" "}
                    </p>
                </Footer>
            </Layout>
        </>
